...
import { formatPhoneNumber, generatePriceOfferMessage, validatePhoneNumber } from "@/lib/whatsapp";
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!priceOffer) {
      return NextResponse.json({ error: "Price offer not found" }, { status: 404 });
    }
